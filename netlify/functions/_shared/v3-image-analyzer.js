  ...
  body:JSON.stringify({
   ...
   messages:[
    {role:"system",content:[
     ...
     "exposureReadable=true seulement si le sujet ET les trois plans gardent des détails visibles sur téléphone ; des reflets isolés dans une image noire ne suffisent pas. goldPresence va de 0 (aucun or) à 1 (or dominant) : quelques points ou liserés valent moins de 0.25, plusieurs surfaces métalliques dorées bien visibles au plan principal et en profondeur valent au moins 0.5. Évaluer la scène brute, jamais le logo ajouté ensuite.",
     "Un paysage ordinaire avec de la brume ou quelques reflets ne justifie pas fantasticObserved=true : le phénomène extraordinaire doit être visible en miniature et lié au thème.",
